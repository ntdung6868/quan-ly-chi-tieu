 ...
 *
 * Nhận data đã prefetch từ Server Component qua HydrationBoundary.
 * useQuery() bên trong các hooks sẽ nhận data ngay lập tức — không loading spinner,
 * không fetch lần đầu, không layout shift.
 *
 * Sau đó TanStack Query tự revalidate in background khi data stale.
 */
export function DashboardContent({
  ...
  // ── Hooks đọc từ hydrated cache — data có ngay, loading = false ──
  const { transactions, loading: txLoading, addTransaction, refetch } = useTransactions({
